...
const actions = {
  createPage({ commit, state }, payload) { // eslint-disable-line
  ...
  getPage({ commit, state }, payload) {// eslint-disable-line
    return http.get(api[GET_PAGE], { id: payload })
  },
  editPage({ commit, state }, payload) {// eslint-disable-line
  ...
  deletePage({ commit, state }, payload) {// eslint-disable-line
